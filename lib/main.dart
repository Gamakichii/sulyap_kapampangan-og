...
void _populateDatabase() {
  final questions = [
    ...
    QuizQuestion(
      ...
      choices: ['Salamat pu!', 'Dakal a salamat!', 'Mayap pu!', 'Sige na pu!'],
    ...
    QuizQuestion(
      question: "I'm hungry",
      choices: ['Mako na ku.', 'Mayap a bengi.', 'Maranup ku.', 'Mapagal ku.'],
    ...
    QuizQuestion(
      question: "I'm sorry.",
      choices: ['Mayap a abak!', 'Pasensya.', 'Salamat pu.', 'Masanting ka?'],
    ...
    QuizQuestion(
      ...
      choices: ['Ali ku balu.', 'Salamat pu.', 'Mayap a aldo.', 'Mako na ku.'],
    ...
    QuizQuestion(
      question: "I'm lost.",
      choices: ['Mewala ku.', 'Mayap a aldo.', 'Salamat pu.', 'Maranup ku.'],
    ...
    QuizQuestion(
      question: "Ing kapatad ku (bought/bumili) _______ yang bayung sapatus.",
    ...
    QuizQuestion(
      question: "Masarap ya ing (food/pagkain) __________ king piestang iti.",
      correctAnswer: 'pamangan',
      difficulty: 'Hard',
    ),
